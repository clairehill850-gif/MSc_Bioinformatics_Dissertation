#!/usr/bin/env python3
# What this does: trains two more architectures (EfficientNet-B3 and ConvNeXt-Tiny) compares to baseline.
import os
import sys
import time
import random
...
from phase2_1_2_transforms import get_val_transform, AUG_CONFIG
from phase2_2_train import (build_loaders, set_backbone_trainable,
...
# Skip cost-sensitive checkpoints
            continue
...
def main():
# Train, then build comparison table
