#!/usr/bin/env python3
# What this does: trains the baseline image classifier (ResNet-50) saves the best version by its macro-F1 score.
import sys
import os
import json
import math
...
from phase2_1_1_dataset import PollenDataset, load_class_index, SPLITS, PROCESSED_ROOT
...
# Build the training and validation data loaders
    train_ds = PollenDataset("train", class_index, transform=get_train_transform())
...
# Freeze or unfreeze the main body of the network
