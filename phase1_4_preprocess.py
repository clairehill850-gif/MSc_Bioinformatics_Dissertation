...
SIZE = 224
# Clip the brightest and darkest 2%
PCT = (2, 98)             
...
def load_rgb(path):
    with Image.open(path) as im:
        try:
# For multi-frame images use the first frame
            im.seek(0)            
...
# Load, square-pad, resize to 224x224, save one image as PNG
    if out_path.exists():
        return "skip"
